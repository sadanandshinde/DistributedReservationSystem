...
public interface ResourceManager extends Remote 
{
    ...
    public void connectToServers() throws RemoteException;
    ...
    /*new transaction support, returns trans Id*/
    public int start() throws RemoteException;
    
    /* client can commit a transaction by transId*/
    public boolean commit(int transactionId) throws RemoteException;
    
    /*shotdown/close the execution if not active transaction exist*/
    public boolean shutdown() throws RemoteException;
    
    /*abort a transaction by transId, delete the changes */
    public boolean abort(int transactionId) throws RemoteException;
    
    /* mimic a failure for this server */
    public boolean selfDestruct() throws RemoteException;
    
    /* receive a serializable transaction log item object back and forth between two ResourceManagers*/
