...
public class client
{
    ...
    public static void main(String args[])
    {
        ...
        case 10: //querying a flight
            ...
            try{
            	...
            	if(seats==-1){
            		System.out.println("the transaction could not be proccessed");
            	}else{
        ...
        case 23:  //New Trnsaction
            ...
            try{
            	...
            	System.out.println("new Transaction Id:"+transId);
            }
            catch(Exception e){
            	System.out.println("EXCEPTION:");
            	System.out.println(e.getMessage());
        ...
        case 24:  //Commit a Transaction
            ...
            System.out.println("Commiting a transaction using  id:"+arguments.elementAt(1));
            try{

            	int transId= obj.getInt(arguments.elementAt(1));
            	boolean success= rm.commit(transId);
            	if(success){
            		System.out.println("The Transaction Id:"+transId +" is successfully commited");
            	}
            	else{
            		System.out.println("The Transaction Id:"+transId +" could not be committed, Sorry");
            	}
            }
            catch(Exception e){
            	System.out.println("EXCEPTION:");
       ...
       case 25:  //Abort a Transaction
            ...
            System.out.println("Aborting a transaction using  xid:"+arguments.elementAt(1));
            try{

            	int transId= obj.getInt(arguments.elementAt(1));
            	rm.abort(transId);

            	System.out.println("The Transaction Id:"+transId +" is successfully aborted");
       ...
       case 26:  //shutdown
           ...
           System.out.println("Calling ot shutdown the Servers");
           try{

          
           	if(rm.shutdown()){
           		System.out.println("The Servers were shutdown successfully");
           	}
           	else{
           		System.out.println("could not shutdown the servers as some transaction might be active");
           	}
           	

           }
           catch(Exception e){
           	System.out.println("shutdown the servers:");
    ...
    switch(findChoice(command))
        ...
        case 23:  //Start a new Transaction
            ...
            System.out.println("Purpose:");
            System.out.println("\tcreates a new transaction and returns transactionId");
            System.out.println("\nUsage:");
            System.out.println("\t start");
            break;
        case 24:  //new transaction
            System.out.println("Commit a transaction");
            System.out.println("Purpose:");
            System.out.println("\t Commits a transaction for the given Xid");
            System.out.println("\nUsage:");
        ...
        case 25:  //abort a transaction
            ...
            System.out.println("Purpose:");
            System.out.println("\tAbort a Transaction for the id provided");
            System.out.println("\nUsage:");
            System.out.println("\tabort, <Xid>");
            break;
        case 26:  //call shutdown
